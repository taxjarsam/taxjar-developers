...
![](/images/guides/square/common-nexus-types.png)
...
<div class="panel panel-warning">
  ...
  <div class="panel-body">
    <p>1. <a href="https://blog.taxjar.com/how-to-register-for-sales-tax-permits/?utm_source=TaxJar&utm_medium=whitepaper&utm_campaign=squareCommerceWPJuly2015">Obtain a sales tax permit</a> (sometimes called sales tax license) for that state (in the cases of third-party sellers this means acquire a license in every state where you warehouse inventory)</p>
    <p>2. Begin collecting sales tax in that state (most states consider it illegal to collect sales tax without a permit)</p>
  </div>
</div>

![](/images/guides/square/nexus-when-to-collect.png)
...
![](/images/guides/square/origin-state-texas.png)
...
![](/images/guides/square/destination-state-new-york.png)
...
![](/images/guides/square/detailed-sales-tax-analysis.jpg)
...
![](/images/guides/square/florida-expected-sales-tax-due.jpg)
