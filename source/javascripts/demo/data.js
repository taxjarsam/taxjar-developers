    ...
    "tasks": {
      "taxForOrder": {
        ...
        "contexts": {
          ...
          "FL": "<ul><li>All of the product categories listed are fully taxable in Florida.</li><li>Florida is a destination-based state, so sales tax is calculated based on the destination of the order or the buyer's shipping address.</li></ul>",
